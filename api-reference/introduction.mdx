...
<CardGroup cols={2}>
  <Card
    ...
    icon="play"
    href="/api-reference/request-file-report-as-url-query-method"
  >
...
<Note>
Each API endpoint has its own dedicated page with an interactive explorer automatically generated from our OpenAPI 3.1 specification. Start with the [Media Analysis endpoints](/api-reference/request-file-report-as-url-query-method) to try analyzing your first media file.
</Note>
