...
When prompted:
1. Provide your **External Admin Key** and **Assistant API Key** from your [Mintlify dashboard](https://dashboard.mintlify.com/settings/organization/api-keys)
2. Select which MCP clients you want to enable

<Note>
After setup, you'll use the command `npx -y mint-mcp docs.probe.dev` to run your MCP server locally in client configurations.
</Note>
